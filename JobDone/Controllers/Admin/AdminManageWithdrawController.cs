...
namespace JobDone.Controllers.Admin
{
    ...
    public class AdminManageWithdrawController : Controller
    {
        ...
        public AdminManageWithdrawController(IWithdraw withdraw, ISeller seller)
        {
            _withdraw = withdraw;
            _seller = seller;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> WithdrawRecords(List<WithdrawModel> withdraws, short TotalRequest, string Option, short TotalRequestToShow, int Count)
        {
